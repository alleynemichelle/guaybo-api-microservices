...
import { bodyParserMiddleware } from 'apps/libs/api/body-parser.middleware';
import { setValidationError } from 'apps/libs/api/set-validation-error.function';
import { setSwaggerConfig } from 'apps/libs/api/set-swagger.function';
import { FRONTEND_DOMAINS } from 'apps/libs/common/constants/domains.constant';
import { setCorsConfig } from 'apps/libs/api/set-cors.function';
...
async function bootstrap(): Promise<any> {
    ...
    if (process.env.STAGE === 'dev') {
        const swaggerDoc = setSwaggerConfig(app, 'Products');
