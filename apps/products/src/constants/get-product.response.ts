        ...
        example: {
            ...
            dates: [
                ...
                },
                {
                    ...
                    totalBookings: 4,
                    status: ProductDateStatus.MANUALLY_OPENED,
                },
            ],
            installments: {
                active: true,
            ...
            postBookingSteps: [
                {
                    recordId: '1660808603',
                    description: 'Por favor, únete al grupo de WhatsApp',
                    conditions: [
                        {
                            value: '9515197498',
                            operator: 'EQUALS',
                    ...
                    title: 'Grupo de whatsapp para plan premium',
                    type: 'WHATSAPP_GROUP',
                    isMandatory: false,
                    customAttributes: {
                        url: {
                            type: 'URL',
                            value: 'https://wa.group/premium-123',
                            required: true,
                        },
                    },
                },
            ...
            discountCodes: [
                {
                    ...
                    name: 'Promoción 25%.',
                    description: '25% off on total price',
                    type: 'PERCENTAGE',
                },
            ],
            location: {
