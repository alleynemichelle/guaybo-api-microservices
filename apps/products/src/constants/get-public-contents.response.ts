...
export class GetPublicContentsResponse extends ResponseDto {
    @ApiProperty({
    ...
    @ApiProperty({
        ...
        example: 'ProductContentsSuccessfullyRetrieved',
    })
    message: string;

    @ApiProperty({
        description: 'Datos obtenidos (solo contenidos con preview=true)',
